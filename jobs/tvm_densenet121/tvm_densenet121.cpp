...
class TVMDensenet121Job : public llis::job::CoroutineJob {
  public:
    ...
    void one_time_init() override {
        ...
        mod_factory_ = tvm::runtime::Module::LoadFromFile(llis::utils::path_concat(std::getenv("LLIS_MODELS_DIR"), "densenet-9-cuda_llis-pack.so"));

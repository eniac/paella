...
class TVMResnet50 : public llis::job::CoroutineJob {
  public:
    ...
    void one_time_init() override {
        ...
        mod_factory_ = tvm::runtime::Module::LoadFromFile(llis::utils::path_concat(std::getenv("LLIS_MODELS_DIR"), "resnet50-v2-7-cuda_llis-pack.so"));

...
class TVMResnet34Job : public llis::job::CoroutineJob {
  public:
    ...
    void one_time_init() override {
        ...
        //mod_factory_ = tvm::runtime::Module::LoadFromFile("resnet34-cuda_llis-pack.so");
        mod_factory_ = tvm::runtime::Module::LoadFromFile("resnet34-v2-7-cuda_llis-pack.so");
